...
const Hero = () => {
    return (
        <div>
            ...
            <section className='bg-[#FBEBB5]'>
                <div className='grid grid-cols-1 lg:grid-cols-2 px-20'>
                    ...
                    <div className='sm:w-[440px] h-[276px] sm:px-14 py-44'>
                        <p className='font-bold text-[25px] md:text-[44px]' data-aos="flip-down">Rocket Single</p>
                        <p className='font-bold text-[25px] md:text-[44px]' data-aos="flip-down">Seater</p>
            ...
            <section className='h-auto md:h-[900px] py-20 px-8 w-full' data-aos="zoom-out-up">
                ...
                <div className='w-full grid grid-cols-1 md:grid-cols-3'>
                    {/* Card 1 */}
                    <div className="sm:w-[240px] flex flex-col items-center">
                        <div>
            ...
            <section className='bg-[#FFF9E5] h-auto md:h-[550px] py-20 px-8'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                    ...
                    {/* right Side */}
                    <div className='pt-10 flex flex-col gap-4 items-center' data-aos="fade-left">
                        <p className='text-xl'>New Arrivals</p>
                        <h1 className='text-[48px] font-extrabold font-mono'>Asgaard sofa</h1>
                        <button type="button" className="text-lg w-[255px] h-[64px] px-5 py-2.5 rounded-md tracking-wider font-bold border border-black outline-none bg-white hover:bg-black text-black hover:text-white transition-all duration-300">Order Now</button>
                    </div>
                </div>
            </section>
            ...
            <section className='px-8 py-8 w-full'>
                {/* Our blogs Heading */}
                <div className='flex flex-col items-center py-8' data-aos="fade-down">
                    <h1 className='text-[36px]'>Our Blogs</h1>
                    <p className='text-[#706f6f]'>Find a bright ideal to suit your taste with our great selection</p>
                </div>
            ...
            <section className='bg-[url("/ins.png")] bg-cover bg-center h-[450px] w-full flex flex-col justify-center items-center'>
                <div className='flex flex-col items-center gap-4' data-aos="zoom-in">
                    ...
                    <button className='font-semibold bg-[#f8d8d8] hover:bg-[#f8e6e6] shadow-lg px-8 py-1 w-[255px] h-[64px] rounded-3xl texl-[20px]'>Follow Us</button>
                </div>
            </section>
        </div>
    )
